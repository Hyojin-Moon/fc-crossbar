                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                  <View style={styles.typeChips}>
                    {statTypes.map((t) => (
                      <Pressable
                        key={t.code}
                        onPress={() => setActiveType(t.code)}
                        style={[styles.chip, t.code === activeType && styles.chipActive]}>
                        <Text
                          style={[styles.chipText, t.code === activeType && styles.chipTextActive]}>
                          {t.label}
                        </Text>
                      </Pressable>
                    ))}
...
const styles = StyleSheet.create({
  ...
  scoreTeam: { fontSize: 13, fontWeight: '700', color: Colors.textSecondary, textAlign: 'center' },
  scoreInput: {
    minWidth: 0,
    minHeight: 52,
    borderWidth: 1,
  ...
  colon: { fontSize: 20, fontWeight: '800', color: Colors.muted, paddingBottom: 14 },
  typeChips: { flexDirection: 'row', gap: Spacing.two, paddingVertical: 2 },
  chip: {
    paddingVertical: 8,
  ...
  rosterNote: { flex: 1, minWidth: 0, fontSize: 12, color: Colors.textSecondary },
  rosterToggle: {
    paddingVertical: 5,
  ...
  rosterToggleText: { fontSize: 11, fontWeight: '700', color: Colors.navy },
  row: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: Spacing.two,
  ...
  name: { flex: 1, minWidth: 0, fontSize: 15, fontWeight: '600', color: Colors.text },
  ...
  value: { minWidth: 26, textAlign: 'center', fontSize: 16, fontWeight: '700', color: Colors.muted },
  valueOn: { color: Colors.navy, fontWeight: '800' },
  toggle: {
    minHeight: 38,
  ...
  toggleText: { fontSize: 13, fontWeight: '700', color: Colors.accent },
